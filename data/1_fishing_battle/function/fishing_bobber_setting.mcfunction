...
# 釣竿の種類を浮きに保存
    execute store result entity @s data.RodType int 1.0 run data get entity @p[tag=PNCT.1FSBT.Player,scores={1FSBT.Player.Used.Fishing_Rod=1..}] SelectedItem.components."minecraft:custom_data".PNCT.1FSBT.ID