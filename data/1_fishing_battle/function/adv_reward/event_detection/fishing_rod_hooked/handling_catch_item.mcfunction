#> 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/handleing_catch_item
#
# FishingBattle：釣ったゲームアイテムの操作
#
# @within function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/

#> Temp Holder
# @within 
#   function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/handling_catch_item
#   function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/**
...
# 通知
    ## Common
        execute as @a[tag=XXXTemp_GetCatchItem] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"PNCT":{"1FSBT":{"CatchItem":{"Fishing_Hooked":true}}}}}}},tag=XXXTemp_Rarity_Common] run function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/1_common
    ## High-Grade
        execute as @a[tag=XXXTemp_GetCatchItem] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"PNCT":{"1FSBT":{"CatchItem":{"Fishing_Hooked":true}}}}}}},tag=XXXTemp_Rarity_High-Grade] run function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/2_high_grade
    ## Different
        execute as @a[tag=XXXTemp_GetCatchItem] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"PNCT":{"1FSBT":{"CatchItem":{"Fishing_Hooked":true}}}}}}},tag=XXXTemp_Rarity_Different] run function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/3_different
    ## Treasure
        execute as @a[tag=XXXTemp_GetCatchItem] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"PNCT":{"1FSBT":{"CatchItem":{"Fishing_Hooked":true}}}}}}},tag=XXXTemp_Rarity_Treasure] run function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/4_treasure
    ## Miss
        execute as @a[tag=XXXTemp_GetCatchItem] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"PNCT":{"1FSBT":{"CatchItem":{"Fishing_Hooked":true}}}}}}},tag=XXXTemp_Rarity_Miss] run function 1_fishing_battle:adv_reward/event_detection/fishing_rod_hooked/notice/5_miss
