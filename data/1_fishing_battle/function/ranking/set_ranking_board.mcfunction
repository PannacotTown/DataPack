...
# ソロ
    ## 1位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 1 2 28 front_text set value {has_glowing_text:true,messages:[[{text:"1st",bold:true,color:"gold",click_event:{action:"run_command",command:"tellraw @s \"solo 1st\""}}],"",{nbt:"Ranking.Solo.$(game_mode).1.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
    ## 2位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 2 2 28 front_text set value {has_glowing_text:true,messages:[[{text:"2nd",bold:true,color:"gray",click_event:{action:"run_command",command:"tellraw @s \"solo 2nd\""}}],"",{nbt:"Ranking.Solo.$(game_mode).2.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
    ## 3位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 3 2 28 front_text set value {has_glowing_text:true,messages:[[{text:"3rd",bold:true,color:"dark_red",click_event:{action:"run_command",command:"tellraw @s \"solo 3rd\""}}],"",{nbt:"Ranking.Solo.$(game_mode).3.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
    ## 4位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 1 1 28 front_text set value {has_glowing_text:true,messages:[[{text:"4th",bold:true,color:"black",click_event:{action:"run_command",command:"tellraw @s \"solo 4th\""}}],"",{nbt:"Ranking.Solo.$(game_mode).4.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
    ## 5位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 2 1 28 front_text set value {has_glowing_text:true,messages:[[{text:"5th",bold:true,color:"black",click_event:{action:"run_command",command:"tellraw @s \"solo 5th\""}}],"",{nbt:"Ranking.Solo.$(game_mode).5.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
    ## 6位
        $execute if data storage 1_fishing_battle:rule {Rule:{GameMode:"$(game_mode)"}} run data modify block 3 1 28 front_text set value {has_glowing_text:true,messages:[[{text:"6th",bold:true,color:"black",click_event:{action:"run_command",command:"tellraw @s \"solo 6th\""}}],"",{nbt:"Ranking.Solo.$(game_mode).6.Name",storage:"1_fishing_battle:save/ranking",bold:true},""]}
# チーム
    ## 1位
